...
export function calculateHouseEstimate(state: HouseCalcState): EstimateResult {
    ...
    sections.push({ 
        ...
        passportItems: [
            ...
            'Лаги пола из сухой строганой доски 150×50 мм',
            'Черновой пол из плит OSB толщиной 22 мм',
            'Утепление пола минеральным утеплителем толщиной 150 мм',
            'Ветрозащитная мембрана по нижней части пола',
            
            '### 2. Наружные стены',
            'Несущий каркас наружных стен из сухой строганой доски 150×50 мм',
            'Утепление наружных стен минеральным утеплителем толщиной 150 мм',
            'Отделка фронтонов фасадной доской планкен',
            'Отделка боковых стен фасада металлическим профилированным листом',
            'Ветрозащитная мембрана наружных стен',

            '### 3. Стены внутренние (Перегородки)',
            ...
            'Утепление кровли минеральным утеплителем толщиной 150 мм',
            'Ветровлагозащитная мембрана кровли',

            '### 5. Окна и Двери',
            'Окна: панорамные и стандартные стеклопакеты',
            'Дверь на террасу',
            'Межкомнатные двери с фурнитурой',

            '### 6. Внутренняя отделка',
            'Подложка под напольное покрытие',
            'Финишное напольное покрытие — ламинат',
            'Влагостойкое напольное покрытие санузла — кварцвинил',
            'Внутренняя отделка стен имитацией бруса (стандарт)',
            'Отделка стен санузла — фанера, зона душевой — кварцвинил',
            'Отделка потолка — натяжной матовый (стандарт)',

            '### 7. Инженерные сети',
            'Базовый пакет электромонтажа',
            'Сантехника и скрытая разводка коммуникаций',
