                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Кол-во модулей</label>
                                    <select name="modulesCount" value={params.modulesCount} onChange={handleChange} className="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                                        <option value="1">1 модуль</option>
                                        <option value="2">2 модуля</option>
                                        <option value="3">3 модуля</option>
                                        <option value="4">4 модуля</option>
                                    </select>
                                </div>
                            </div>
