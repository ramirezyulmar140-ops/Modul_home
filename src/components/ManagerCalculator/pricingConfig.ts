export const PRICING_CONFIG = {
    // Фундамент
    foundationPile108: 5950, // Цена с работой 1 свая
    ...
    // Инженерия
    electricalPoint: 1500,    // Электрика за 1 м2 (или точка)
    ...
    workRoofingM2: 1200,         // Монтаж кровельного покрытия за 1 м2
    workFacadePlankenM2: 1500,   // Монтаж планкена фасада с покраской за 1 м2
    workFacadeProflistM2: 800,   // Монтаж фасадного профлиста за 1 м2
    ...
    workFloorBaseM2: 500,        // Укладка ламината/линолеума за 1 м2
    workFloorQuartzM2: 700,      // Укладка кварцвинила за 1 м2
